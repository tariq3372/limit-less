                                    ...
                                    <div className="recent">
                                        <div className="ac prev">
                                            ...
                                            <div>
                                                ...
                                                <Link to="/blog-details" className="title">OpenSea NFT Marketplace to Solely Support Ethereum’s Upgraded...</Link>
                                            </div>
                                        ...
                                        <div className="ac next">
                                            ...
                                            <div>
                                                ...
                                                <Link to="/blog-details" className="title">MTV Music Awards to See Eminem, Snoop Dogg Perform in Bored...</Link>
                                            </div>
